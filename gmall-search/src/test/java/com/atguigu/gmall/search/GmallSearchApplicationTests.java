            ...
            spuEntities.forEach(spuEntity -> {
                ...
                if (!CollectionUtils.isEmpty(skuEntities)){
                    ...
                    List<Goods> goodsList = skuEntities.stream().map(skuEntity -> {
                        ...
                        //设置库存的相关信息
                        ResponseVo<List<WareSkuEntity>> wareResponseVo = gmallWmsClient.queryWareSkusByskuId(skuEntity.getId());
                        ...
                        //查询销售类型的检索参数
                        ResponseVo<List<SkuAttrValueEntity>> skuAttrValueResponseVo = gmallPmsClient.querySearchSkuAttrValuesByCidAndSkuId(skuEntity.getCatagoryId(), skuEntity.getId());
                        ...
                        //查询基本类型的检索参数
                        ResponseVo<List<SpuAttrValueEntity>> spuAttrValueResponseVo = gmallPmsClient.querySearchSpuAttrValuesByCidAndSpuId(skuEntity.getCatagoryId(), spuEntity.getId());
