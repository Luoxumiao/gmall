...
public class AttrController {
    ...
    public ResponseVo<List<AttrEntity>> queryAttrsByGroupId(@PathVariable("gid") Long gid){
        List<AttrEntity> attrEntityList = attrService.list(new QueryWrapper<AttrEntity>().eq("group_id", gid));
